...
<html>
	<head>
		...
		<?php
			session_start();
			$query="select pwd, admin_pwd,manager from password where accessTo='inwards';";
		...
		<script>
			function checkpwd()
			{
				...
				else
				{
					...
					form.method='post';
					form.action='inwards_redirect.php';
	...
	<body>
		<div class = "login-form">
			<big><big>Inwards Manager</big></big>
